...
import { starterArticles } from "@/data/starter";
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-10">
      ...
      <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
        Curated pieces to bootstrap your decks. Import directly, or adapt a
        piece to your level in Claude.ai first using the prompt each page
        provides.
      </p>
